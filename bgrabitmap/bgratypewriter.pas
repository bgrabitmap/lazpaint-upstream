...
type
  ...
  protected
    ...
    class procedure ReadHeader(AStream: TStream; out AName: string; out AContentSize: longint); {$if FPC_FULLVERSION>=030100}static;{$endif}
  ...
  public
    ...
    class function LoadFromStream(AStream: TStream): TBGRAGlyph; {$if FPC_FULLVERSION>=030100}static;{$endif}
  end;
