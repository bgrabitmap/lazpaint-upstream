...
ifeq ($(UNAME),Linux)
  ...
  INTERFACE:=LCLgtk2
  LAZARUSDIRECTORIES:="-Fu$(lazdir)/*" "-Fi$(lazdir)/*" "-Fl$(lazdir)/*" "-Fo$(lazdir)/*" "-Fu$(lazdir)/components/printers/unix" "-Fi$(lazdir)/components/printers/unix" "-Fl$(lazdir)/components/printers/unix" "-Fo$(lazdir)/components/printers/unix" "-Fu$(lazdir)/packager/registration" "-Fi$(lazdir)/packager/registration" "-Fl$(lazdir)/packager/registration" "-Fo$(lazdir)/packager/registration" "-Fu$(lazdir)/components/*" "-Fi$(lazdir)/components/*" "-Fl$(lazdir)/components/*" "-Fo$(lazdir)/components/*" "-Fu$(lazdir)/lcl/forms" "-Fi$(lazdir)/lcl/forms" "-Fl$(lazdir)/lcl/forms" "-Fo$(lazdir)/lcl/forms" "-Fu$(lazdir)/lcl/widgetset" "-Fi$(lazdir)/lcl/widgetset" "-Fl$(lazdir)/lcl/widgetset" "-Fo$(lazdir)/lcl/widgetset" "-Fu$(lazdir)/interfaces/*" "-Fi$(lazdir)/interfaces/*" "-Fl$(lazdir)/interfaces/*" "-Fo$(lazdir)/interfaces/*" "-Fu$(lazdir)/lcl/nonwin32" "-Fi$(lazdir)/lcl/nonwin32" "-Fl$(lazdir)/lcl/nonwin32" "-Fo$(lazdir)/lcl/nonwin32" "-Fu$(lazdir)/lcl/interfaces/gtk2" "-Fi$(lazdir)/lcl/interfaces/gtk2" "-Fl$(lazdir)/lcl/interfaces/gtk2" "-Fo$(lazdir)/lcl/interfaces/gtk2" "-Fu$(lazdir)/lcl/components/*" "-Fi$(lazdir)/lcl/components/*" "-Fl$(lazdir)/lcl/components/*" "-Fo$(lazdir)/lcl/components/*" "-Fu$(lazdir)/lcl/include" "-Fi$(lazdir)/lcl/include" "-Fl$(lazdir)/lcl/include" "-Fo$(lazdir)/lcl/include" "-Fu$(lazdir)/lcl" "-Fi$(lazdir)/lcl" "-Fl$(lazdir)/lcl" "-Fo$(lazdir)/lcl"
endif

ifeq ($(UNAME),Windows)
  INTERFACE:=LCLwin32
  LAZARUSDIRECTORIES:="-Fu$(lazdir)/*" "-Fi$(lazdir)/*" "-Fl$(lazdir)/*" "-Fo$(lazdir)/*" "-Fu$(lazdir)/components/printers/win32" "-Fi$(lazdir)/components/printers/win32" "-Fl$(lazdir)/components/printers/win32" "-Fo$(lazdir)/components/printers/win32" "-Fu$(lazdir)/packager/registration" "-Fi$(lazdir)/packager/registration" "-Fl$(lazdir)/packager/registration" "-Fo$(lazdir)/packager/registration" "-Fu$(lazdir)/components/*" "-Fi$(lazdir)/components/*" "-Fl$(lazdir)/components/*" "-Fo$(lazdir)/components/*" "-Fu$(lazdir)/lcl/forms" "-Fi$(lazdir)/lcl/forms" "-Fl$(lazdir)/lcl/forms" "-Fo$(lazdir)/lcl/forms" "-Fu$(lazdir)/lcl/widgetset" "-Fi$(lazdir)/lcl/widgetset" "-Fl$(lazdir)/lcl/widgetset" "-Fo$(lazdir)/lcl/widgetset" "-Fu$(lazdir)/interfaces/*" "-Fi$(lazdir)/interfaces/*" "-Fl$(lazdir)/interfaces/*" "-Fo$(lazdir)/interfaces/*" "-Fu$(lazdir)/lcl/interfaces/win32" "-Fi$(lazdir)/lcl/interfaces/win32" "-Fl$(lazdir)/lcl/interfaces/win32" "-Fo$(lazdir)/lcl/interfaces/win32" "-Fu$(lazdir)/lcl/components/*" "-Fi$(lazdir)/lcl/components/*" "-Fl$(lazdir)/lcl/components/*" "-Fo$(lazdir)/lcl/components/*" "-Fu$(lazdir)/lcl/include" "-Fi$(lazdir)/lcl/include" "-Fl$(lazdir)/lcl/include" "-Fo$(lazdir)/lcl/include" "-Fu$(lazdir)/lcl" "-Fi$(lazdir)/lcl" "-Fl$(lazdir)/lcl" "-Fo$(lazdir)/lcl"
endif
...
ifeq "$(lazdir)" ""
	...
	cd lazpaint $(THEN) fpc -orelease/lazpaint -Fu./buttons -Fi./buttons -Fl./buttons -Fo./buttons -Fu./image -Fi./image -Fl./image -Fo./image -Fu./cursors -Fi./cursors -Fl./cursors -Fo./cursors -Fu./buttons -Fi./buttons -Fl./buttons -Fo./buttons -Fu./* -Fi./* -Fl./* -Fo./* -Fu../bgracontrols -Fi../bgracontrols -Fl../bgracontrols -Fo../bgracontrols -Fu../bgrabitmap -Fi../bgrabitmap -Fl../bgrabitmap -Fo../bgrabitmap $(LAZARUSDIRECTORIES) -MObjFPC -Scgi -Cg -OoREGVAR -Xs -XX -l -vewnhibq -O3 -XX -CX -Xs -vi -FUrelease/lib/ -dLCL -d$(INTERFACE) lazpaint.lpr
endif
